...
/// - Scale (0.5-1.0, where 1.0 fills the frame completely, default: 0.92)
/// - Background type (white, black, or extended blur)
/// - Blur intensity (1-100, only used when background is extended blur, default: 75)
/// - Image quality (1-100 JPEG quality)
/// - Target dimensions for export
class PhotoSettings extends Equatable {
  final AspectRatio aspectRatio;
  final double scale; // 0.5 to 1.0 (100% = fill completely, default: 0.92)
  final BackgroundType backgroundType;
  final int blurIntensity; // 1-100 (blur radius, only for extendedBlur background, default: 75)
